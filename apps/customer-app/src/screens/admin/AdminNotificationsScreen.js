...
const styles = StyleSheet.create({
  ...
  segmentRow: { flexDirection: 'row', gap: spacing.sm, paddingHorizontal: spacing.lg, paddingTop: spacing.md, paddingBottom: spacing.sm },
  segment: { flex: 1, borderRadius: radius.pill, paddingVertical: 10, alignItems: 'center', backgroundColor: colors.bgSurface, borderWidth: 1, borderColor: colors.border },
  ...
  fieldLabel: { fontSize: 12, fontWeight: '700', color: colors.textSecondary, marginBottom: spacing.xs, marginTop: spacing.sm, textTransform: 'uppercase' },
  chipsRow: { flexDirection: 'row', flexWrap: 'wrap', gap: spacing.sm },
  chip: { borderRadius: radius.pill, paddingHorizontal: spacing.md, paddingVertical: 8, backgroundColor: colors.bgSurface, borderWidth: 1, borderColor: colors.border },
  chipActive: { backgroundColor: colors.saffron, borderColor: colors.saffron },
  chipText: { fontSize: 12, fontWeight: '700', color: colors.textSecondary },
  chipTextActive: { color: colors.textInverse },
  input: { borderWidth: 1, borderColor: colors.border, borderRadius: radius.lg, paddingHorizontal: spacing.md, paddingVertical: 10, color: colors.textPrimary, marginBottom: spacing.xs },
  textArea: { borderWidth: 1, borderColor: colors.border, borderRadius: radius.lg, paddingHorizontal: spacing.md, paddingVertical: 10, color: colors.textPrimary, textAlignVertical: 'top', marginBottom: spacing.xs },
  hint: { fontSize: 11, color: colors.textTertiary, marginBottom: spacing.sm },
  sendBtn: { backgroundColor: colors.saffron, borderRadius: radius.button, paddingVertical: spacing.sm, alignItems: 'center', marginTop: spacing.md },
  ...
  broadcastRow: {
    flexDirection: 'row', backgroundColor: colors.bgSurface, borderRadius: radius.lg, borderWidth: 1, borderColor: colors.border,
  ...
  deleteLink: { fontSize: 12, fontWeight: '700', color: colors.error, alignSelf: 'flex-start' },
  templateCard: {
  ...
  templateActionsRow: { flexDirection: 'row', gap: spacing.sm, marginTop: spacing.sm },
  smallBtn: { backgroundColor: colors.saffron, borderRadius: radius.button, paddingHorizontal: spacing.md, paddingVertical: 8 },
  smallBtnText: { color: colors.textInverse, fontWeight: '800', fontSize: 12 },
  smallBtnSecondary: { borderRadius: radius.button, paddingHorizontal: spacing.md, paddingVertical: 8, borderWidth: 1, borderColor: colors.border },
