...
export default function Orders() {
  ...
  useEffect(() => {
    ...
    // or cancels an order — otherwise the drawer would stay open on the
    // previous order and hide the new one in the list behind it.
    const onCloseDrawer = () => setSelectedOrder(null);
