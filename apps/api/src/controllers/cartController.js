...
const calculateCart = async (req, res) => {
  ...
  const [settingRows] = await pool.query(
    'SELECT shop_open, minimum_order_amount, delivery_charge, night_charge, night_charge_start, night_charge_end, below_threshold_delivery_charge, free_delivery_above_minimum_active, free_delivery_offer_active, fast_delivery_enabled, fast_delivery_charge, standard_delivery_minutes, fast_delivery_minutes, delivery_radius_km FROM settings LIMIT 1'
  );
